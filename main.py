...
def process_csv(file_path):
    ...
    with open(file_path, 'r') as file:
        ...
        for row in reader:
            ...
            resource_arn_column = find_column_by_suffix(row, "providerUniqueId")
            ...
            if not resource_type_column or not resource_arn_column or not region_column:
            ...
            try:
                ...
                tagger = AwsResourceTaggerFactory.get_tagger(resource_type, resource_arn, tags, region, account_id)
                tagger.add_tags()
