...
def process_csv(file_path):
    ...
    with open(file_path, 'r') as file:
        ...
        for row in reader:
            ...
            tags = [
                {"Key": "AppCategory", "Value": "Workflow and Automation"},
                {"Key": "Brand", "Value": "Digital Toucan"},
                {"Key": "DeploymentType", "Value": "Manual"},
                {"Key": "Environment", "Value": "Production"},
                {"Key": "AdminEmail", "Value": "daniel.turczanski@appfire.com"},
                {"Key": "OwningOrg", "Value": "DevOps"},
